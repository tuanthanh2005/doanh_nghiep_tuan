        ...
        <div class="row footer_bg">
            <div class="col-lg-3 col-sm-6 col-xs-12">
                ...
                <div class="social_profile">
                    <ul>
                        <li><a href="https://zalo.me/0708910952" target="_blank" class="f_facebook" title="Zalo" style="display: flex !important; align-items: center; justify-content: center; text-decoration: none;"><i class="fa fa-whatsapp" style="font-size: 20px;"></i></a></li>
                        <li><a href="https://t.me/specademy" target="_blank" class="f_twitter" title="Telegram" style="display: flex !important; align-items: center; justify-content: center; text-decoration: none;"><i class="fa fa-paper-plane" style="font-size: 20px;"></i></a></li>
                        <li><a href="mailto:devitvn00@gmail.com" class="f_instagram" title="Email" style="display: flex !important; align-items: center; justify-content: center; text-decoration: none;"><i class="fa fa-envelope" style="font-size: 20px;"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="footer_copyright">
                    <p>&copy; {{ date('Y') }}
                        {{ \App\Models\Setting::get('footer_copyright', 'Tuấn Code Claud. Bảo lưu mọi quyền.') }}
                    </p>
                </div>
            </div>
